  ...
  experience: [
    {
      ...
      para1: "During my time at TRIUMF, I worked with the PIONEER group on a rare pion decay experiment. The experiment is to be conducted in a large liquid xenon (LXe) calorimeter - it is necessary to be able to monitor the purity levels of the xenon inside of it at all times during the experiment. To acheive this, I was invovled with the development of a Purity Monitor Assembly (PUMA) and its calibration deviceto be used in high-precision experiments with LXe calorimeters.",
      ...
      img3_2: "/test2.png",
      img3_3: "/test3.jpg",
      para5: "Working at TRIUMF was a great experience and I enjoyed being in charge of a project within a larger physics context. I got to experience both self-led work and collaboration with a team.",
    ...
    },
    {
      ...
      para2: "While working on the naigvation side of the software for our robot, I developed ROS (Robot Operating System) Python scripts to allow the robot to navigate new, dynamic environments. This meant integrating various sensors with software and developing communication protocols for the robot's subsystems. I did all ROS work on Linux (Ubuntu 20.04). I also performed research and analysis of LIDAR sensors and SLAM (Simultaneous Localization and Mapping) frameworks to be used for the robot.",
      img1_1: "/ros2.jpg",
      img1_2: "/ros3.png",
      img1_3: "/ros1.jpg",
      para3: "Further, during my first few months of joining Open Robotics, I performed a mechanical onboarding for the team. This included designing a chassis for a simple robot using OnShape CAD and 3D printing various mechanical components. In this time, I learned about mechanical design and robotics in the industry.",
      img2_1: "/chass1.jpg",
      img2_2: "/chass2.jpg",
      img2_3: "/chass3.jpg",
      bullets: [
