export const siteConfig = {
  ...
  projects: [
    ...
    },
    {
      ...
      description:
        "Applied machine learning, computer vision, and software techniques to develop and train various neural networks from scratch to allow a robot to autonomously drive through and solve a puzzle in ROS Gazebo simulation. Achieved perfect score and second place in ENPH 353 course competition.",
