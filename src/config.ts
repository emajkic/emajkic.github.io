  ...
  experience: [
    {
      ...
      description: "Worked with Purity Monitor Assembly (PUMA) instrument for high-precision rare pion decay experiment, PIONEER. Developed physics simulations with C++ and Python; designed vacuum system for PUMA testing.",
      ...
      img3_2: "/test2.png",
      img3_3: "/test3.jpg",
      link_video: "https://youtu.be/ad_hZ0_KblQ?si=tm9LHOQSrlhpLQJ5",
